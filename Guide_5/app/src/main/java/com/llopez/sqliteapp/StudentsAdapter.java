...
public class StudentsAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        carnet.setText(cursor.getString(cursor.getColumnIndex(StudentsContract.Columnas.CARNET)));

        TextView nombre = (TextView) view.findViewById(R.id.nombre_text);
        nombre.setText(cursor.getString(cursor.getColumnIndex(StudentsContract.Columnas.NOMBRE)));

        TextView apellido = (TextView) view.findViewById(R.id.apellido_text);
        apellido.setText(cursor.getString(cursor.getColumnIndex(StudentsContract.Columnas.APELLIDO)));
    }
